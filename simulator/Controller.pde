class Controller {
  ...
  // params
  private final int DEGREE_ACC = 5;            // radial partitions is 360 / DEGREE_ACC; ie if DEGREE_ACC is 2 then theres 18 radial partitions
  private final int RADIAL_RES = 5;             // radial resolution, or how many LEDs per blade, whichever you prefer
