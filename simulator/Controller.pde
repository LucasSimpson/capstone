class Controller {
  ...
  // params
  private final int DEGREE_ACC = 60;            // radial partitions is 360 / DEGREE_ACC; ie if DEGREE_ACC is 2 then theres 18 radial partitions
  private final int RADIAL_RES = 2;             // radial resolution, or how many LEDs per blade, whichever you prefer
  private final int NUM_BLADES = 2;             // i feel this is pretty self-explanitory, but i dont wanna break the comment streak
  ...
  private final float SCALE_Z = 100;      // vertical scale factor, for visualization
